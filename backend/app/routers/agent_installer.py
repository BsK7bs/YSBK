...
async def download_installer(
    ...
    if AGENT_EXE_PATH.exists():
        ...
        install_cmd_bytes = (
            ...
            "echo       done.\r\n"
            "\r\n"
            "echo [2/5] Terminating any leftover agent executables ...\r\n"
            ">nul 2>&1 taskkill /F /IM agent.exe\r\n"
            ">nul 2>&1 taskkill /F /IM DigitalTwinAgent.exe\r\n"
            ">nul 2>&1 taskkill /F /IM uninstaller.exe\r\n"
            "echo       done.\r\n"
            "\r\n"
